...
function ListaEmail() {
  ...
  return (
    <div className="flex flex-col w-full items-center bg-teal-50	 shadow  md:flex-col">
      <h2 className="mb-2 flex flex-col center bg-teal-500 justify-center w-full text-3xl text-white h-36">
