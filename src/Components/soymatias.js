...
function Soymatias() {
    return ( <
        div id = "matias"
        className = "flex w-full flex-wrap w-full justify-center " >
        ...
        <
        img className = "flex max-w-sm overflow-hidden p-4"
        src = { imgMatias }
        alt = "Matias Viettro" / >
        ...
        <
        div className = "flex flex-col max-w-xl flex-0 center leading-10 text-xxl text-emerald-400 justify-center" >
        <
