...
const Servicios = () => {
    return ( <
        ...
        image = { ux }
        />{' '} { ' ' } <
        TarjetaServicio titulo = "Identidad Visual"
        ...
        image = { ojo }
        />{' '} { ' ' } <
        TarjetaServicio titulo = "Optimización SEO/SEA"
        ...
        image = { lupa }
        />{' '} { ' ' } <
        TarjetaServicio titulo = "Responsive"
        ...
        image = { smart }
        />{' '} { ' ' } <
        TarjetaServicio titulo = "Animaciones"
...
const TarjetaServicio = ({ titulo, descripcion, image }) => {
    return ( <
        ...
        img src = { image }
        alt = { titulo }
        className = " self-center" / > < h3 className = "justify-start" > { titulo } < /h3>  {' '} <
        p > { descripcion } < /p>  {' '} <
        /div>
    );
};
