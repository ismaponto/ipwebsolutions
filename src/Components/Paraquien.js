...
function Paraquien() {
    return ( < div className = "flex flex-wrap w-full  justify-center md:flex-col mb-8" >
        ...
        <
        div className = "flex flex-col max-w-lg flex-0 center text-xl text-emerald-400 justify-center" >
        <
        ...
        <
        div className = "flex flex-col max-w-lg flex-0 center text-xl text-emerald-400 p-9" >
        <
