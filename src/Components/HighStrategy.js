...
const HighStrategy = () => {
    return ( <
        div id = { "metodo" }
        className = "Highstrategy p-8 flex center flex-col" >
        <
        ...
        "High Stratégie Method: Transforma tus sueños en realidad" < /span>{" "}      </h
        1 >
        <
        ...
        img className = "h-auto max-w-lg-full mx-auto"
        src = { imgHigh }
        alt = "High Stratégie Method" / >
        <
        /div>
    );
};
