    ...
    return (
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal bg-gray-50 font-manrope text-gray-700 dark:text-gray-400">Desde 2017 que intentaba vivir de la fotografia, pero no fue hasta que empece a aplicar el metodo de High Stratégie que pude dejar mi trabajo de 5 por 8 para poder vivir </p>
